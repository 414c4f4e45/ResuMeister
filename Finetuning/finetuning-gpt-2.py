...
# Define the folder containing JSONL files
folder_path = 'jsonl_files'  # replace with your folder path

# Prepare a list to collect the data
data = []

# Process each JSONL file in the folder
for file_name in os.listdir(folder_path):
    if file_name.endswith('.jsonl'):
        context = os.path.splitext(file_name)[0]  # Get file name without .jsonl
